    ...
    private void btnShowAllEmpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowAllEmpActionPerformed
        ...
        try {
            ...
            while(itr.hasNext())
            {
               ...
               e= (EmpPojo) itr.next();
               txtShowAllEmp.append(e.toString());
            }
        } 
        catch (SQLException ex) {
            JOptionPane.showMessageDialog(null,"records cannot find ");
            ex.printStackTrace();
        }
